				...
				<div class="box span6">
					...
					<div class="box-content">
						<table class="table">
							  ...
							  <tbody>
								<tr>
									 @foreach($order_info_by_id as $v_order)
									 @endforeach 
						...
						<table class="table table-striped">
							  ...
							  <tbody>
								<tr>
									@foreach($order_info_by_id as $v_order)
									 @endforeach
								      <td>{{$v_order->shipping_full_name}}</td>
						...
						<table class="table table-striped ">
						 ...
						 @foreach($order_info_by_id as $v_order)							  	 
							<tr>
				             ...
				             <td>{{$v_order->product_sale_quantity}}</td> 
                             <td>{{$v_order->product_price*$v_order->product_sale_quantity}}</td>
